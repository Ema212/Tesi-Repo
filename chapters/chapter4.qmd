...
$$
[@lakens2013calculating; @morris2002combining]
...
Abbiamo condotto
- una poweranalysis sotto d.50
- una poweranalysis sotto d.55
- una poweranalysis sotto d.60

The R code of the anlaysis is included in Appendix B.

## Results

Bellissime tabelle e grafici

TITOLO IN NESSUN GRAFICO

Io dico solo come leggere il grafico in un ottica di trade off tra robustness e feasibility
Inoltre bisogna radooppiare il campione eprché two arms.

## Discussion

It is important to acknowledge that this methodological approach has specific limitations, which we will  address in detail in the following chapter.
...
In the next and final chapter, we will summarize the main findings of this work, discuss its methodological limitations, and outline possible directions for future research.
