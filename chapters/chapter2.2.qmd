...
\hline  
\textbf{Cons}   & • Practically uninfromative   & • Strongly subjective\\
\hline  
\textbf{Require}   & • High-quality meta-analysis & • Attentive esteems procedures\\
...
\vspace{0.5cm}
![A graphical rapresentation of the hypothethical SESOIs.](../figures/3effs.png){width=80% fig-align=center}
...
\vspace{0.5cm}
![The comparison between the plausile effect size and the SESOIs.](../figures/graphmatch.png){width=80% fig-align=center}
