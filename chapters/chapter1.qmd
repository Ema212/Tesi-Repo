...
As Eronen and Bringmann highlighted we should invest more energy into building stronger and more precise theories [@eronen2021]. However psychology is a challenging field, and to build strong theories we first need to identify clear phenomena. Therefore, some argue they should focus more on exploratory research [@fife2022understanding; @oberauer2019addressing; @scheel2021hypothesis], and in phenomenon-driven research, as it helps constrain the space of plausible theories [@eronen2021].
